    ...
    <BrowserRouter>
      <div className="app-shell flex min-h-screen flex-col bg-gray-100 transition-colors duration-300 md:h-screen md:flex-row">
        ...
        <div className="flex min-w-0 flex-1 flex-col overflow-y-auto">
          <header className="app-header sticky top-0 z-10 flex items-center justify-between border-b border-gray-200 bg-white/80 px-4 py-4 backdrop-blur-xl sm:px-6">
          ...
          <footer className="app-footer flex flex-col gap-2 border-t border-gray-200 bg-white px-4 py-4 text-xs text-gray-500 sm:flex-row sm:items-center sm:justify-between sm:px-6">
