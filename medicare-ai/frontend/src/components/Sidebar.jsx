...
import { LayoutDashboard, Bot, Stethoscope, User } from 'lucide-react'
...
function Sidebar() {
  return (
    <aside className="flex h-screen w-64 flex-col justify-between border-r border-gray-200 bg-white px-4 py-6">
      <div>
